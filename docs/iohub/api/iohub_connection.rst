...
The ioHub Event Framework runs in a seperate process ( called the ioHub Process )
from that of the Python interpreter your PsychoPy experiment is exceuted within (called the PsychoPy Process).
...
#. Optionally display an Experiment Session Information Dialog, which can be customized within the experiment_config.yaml for each experiment, allowing collection of relevent participant data prior to the start of the experiment itself.
