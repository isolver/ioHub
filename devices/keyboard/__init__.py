...
if Computer.system == 'Windows':
    ...
    class Keyboard(ioHubKeyboardDevice,KeyboardWindows32):
        def __init__(self,*args,**kwargs):
            ...
            Keyboard.ALL_EVENT_CLASSES=[KeyboardPressEvent, KeyboardReleaseEvent,KeyboardCharEvent]
            deviceSettings={
            ...
            ioHubKeyboardDevice.__init__(self,*args,**deviceSettings)
            KeyboardWindows32.__init__(self,*args,**deviceSettings)

elif Computer.system == 'Linux':
    from _linux import KeyboardLinux
    class Keyboard(ioHubKeyboardDevice,KeyboardLinux):
        def __init__(self,*args,**kwargs):
            ...
            self._startupConfiguration=deviceConfig
            ioHubKeyboardDevice.__init__(self,*args,**deviceSettings)
            KeyboardLinux.__init__(self,*args,**deviceSettings)
...
class KeyboardEvent(DeviceEvent):
    """
    The Keyboard Event class is an abstract class that is the parent of all
    ...
    def createEventAsDict(cls,values):
        ed=super(KeyboardEvent,cls).createEventAsDict(values)
