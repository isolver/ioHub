...
from ioHub.constants import EventConstants, KeyboardConstants #, #DeviceConstants, EyeTrackerConstants
...
#        ioHub.print2err('_unregisterEventMonitors')
    ...
    def _handleEvent(self,ioe):
        ...
        event_type_index=ioDevices.DeviceEvent.EVENT_TYPE_ID_INDEX
...
#            ioHub.print2err('** KEY: ', ioe[-4]," ,key_id: ",ioe[-5]," ,ascii_code: ",ioe[-6]," ,scan_code: ",ioe[-7])               
        ...
        elif ioe[event_type_index] == EventConstants.MOUSE_PRESS:
#            ioHub.print2err('Should handle mouse pressed event for button id: ', ioe[-7])
            self.state=1
        elif ioe[event_type_index] == EventConstants.MOUSE_RELEASE:
