...
from .... eye_events import MonocularEyeSample, BinocularEyeSample, FixationStartEvent, FixationEndEvent
    ...
    def __init__(self, *args, **kwargs):
        ...
        **If an instance of EyeTracker has already been created, trying to create a second will raise an exception. Either destroy the first instance and then create the new instance, or use the class method EyeTracker.getInstance() to access the existing instance of the eye tracker object.**
        ...
        try:
            ...
            EyeTracker.ALL_EVENT_CLASSES=(MonocularEyeSample,BinocularEyeSample,FixationStartEvent,FixationEndEvent)
            ...
            deviceSettings = {
                ...
                'max_event_buffer_length':dconfig.get('event_buffer_length')
                }
            ...
            EyeTracker.displaySettings = self._startupConfiguration['display_settings']
            
            screen_index = EyeTracker.displaySettings['display_index']
            
            ioHub.print2err("screen_index: ",screen_index," cal_pts : ",cal_pts)
            #===================================================================
            # implementation specific SMI attributes
            #===================================================================
            #the SMI API
