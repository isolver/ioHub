""" 
Copyright (C) 2012 XXXXXXXXXXXXX, Sol Simpson 
Distributed under the terms of the GNU General Public License (GPL version 3 or any later version). 

.. moduleauthor:: XXXXXXXXXXXXXX + contributors, please see credits section of documentation.
"""
...
class EyeTracker(Device):
    ...
    DEVICE_INFO={'manufacturer':'SR Research Ltd.', \
    'model':'unknown', \
    'model_number':'unknown', \
    'hardware_revision': 'unknown', \
    'serial_number':'unknown', \
    'software_version':'unknown', \
    'notes':'Access via pyEyeTrackerInterface v2.0 beta' \
    }
    ...
    def __init__(self,*args,**kwargs):
        ...
        **If an instance of EyeTracker has already been created, trying to create a second will raise an exception. Either destroy the first instance and then create the new instance, or use the class method EyeTracker.getInstance() to access the existing instance of the eye tracker object.**
        ...
        print "Welcome to the SMI iViewX implementation of the pyEyeTrackerInterface!"
    ...
    def createRecordingFile(self, fileName, path=None, **kwargs):
        """
