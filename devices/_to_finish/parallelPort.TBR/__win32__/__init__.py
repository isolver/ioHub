...
class ParallelPortWin32(object):
    ...
    def _poll(self):
        ...
        if currentValue == self.lastReadValue:
            ...
            time=currentTime-int(pdelay)

            ppe= [0,0,Computer._getNextEventID(),ParallelPortEvent.EVENT_TYPE_ID,
                  device_time, logged_time, time, ci,pdelay,0,self.base_address,currentValue,lrv]
