"""
ioHub
.. file: ioHub/devices/eyeTrackerInterface/HW/devices/pyEyeTrackerInterface/eyeTeck/QuickLink/eyetracker.py

Copyright (C) 2012 EyeTech Inc., Sol Simpson
Distributed under the terms of the GNU General Public License (GPL version 3 or any later version).

.. moduleauthor:: Sol Simpson <sol@isolver-software.com> + contributors, please see credits section of documentation.
.. fileauthor:: Eye Tech Inc.
"""

import numpy as N
import ioHub
from ioHub.devices import Computer
from .... import RTN_CODES, DATA_FILTER, DATA_STREAMS
from .... import EyeTrackerInterface

			  
from ctypes import *
from quicklink2 import  *      
...
class EyeTracker(EyeTrackerInterface):
    ...
    def __init__(self,*args,**kwargs):
        ...
        **If an instance of EyeTracker has already been created, trying to create a second will raise an exception. Either destroy the first instance and then create the new instance, or use the class method EyeTracker.getInstance() to access the existing instance of the eye tracker object.**
        ...
        EyeTrackerInterface.__init__(self,*args,**kwargs)
    ...
    def experimentStartDefaultLogic(self,*args,**kwargs):
        ...
        if 'filename' in kwargs:
            ...
            recording_filename=(self._runtime_settings['default_native_data_file_name'])+'.edf'
