...
class EyeTracker(EyeTrackerDevice):
    ...
    def setConnectionState(self,enable):
        """
        """
        ioHub.print2err("EyeLink Interface Warning: setConnectionState is not Handling DUMMY yet.")
        try:
    ...
    def _setRuntimeSettings(self,runtimeSettings):
        ...
        for pkey,v in runtimeSettings.iteritems():
            ...
            if pkey in ['enable_interface_without_connection','network_settings']:
                ...
                ioHub.print2err("EyeLink Interface Warning: simulation_mode not yet implemented: {0} val: {1}".format(pkey,v))
                ...
                for vog_key,vog_val in v.iteritems():
                    ...
                    if vog_key == 'pupil_measure_types':
                        ...
                        ioHub.print2err("WARNING: unhandled eye tracker config setting ( in sub group vog_settings):",vog_key,vog_val)
                        ioHub.print2err("")
            else:
    ...
    def _setEyesToTrack(self,track_eyes):
        ...
        try:
            ...
            if track_eyes is None:
                ioHub.print2err("** Warning: UNKNOWN EYE CONSTANT, SETTING EYE TO TRACK TO RIGHT. UNKNOWN EYE CONSTANT: ",track_eyes)
                track_eyes='RIGHT'
    ...
    def _eyelinkSetScreenPhysicalData(self):
        try:        
            ...
            if sdist:
                ...
                ioHub.print2err('ERROR: "default_eye_distance":"surface_center" value could not be read from monitor settings')
                return False
            ...
            if sdim:
                ...
                ioHub.print2err('ERROR: "physical_stimudisplay_x,display_ylus_area":"width" or "height" value could not be read from monitor settings')
                return False
