...
lctigaze = cdll.LoadLibrary("lctigaze.dll")

egc= stEgControl()
egc.iNDataSetsInRingBuffer=100
egc.bTrackingActive=False
egc.iScreenWidthPix=1920
egc.iScreenHeightPix=1080
egc.bEgCameraDisplayActive=True
egc.iCommType=EG_COMM_TYPE_LOCAL
egc.iVisionSelect=0
egc.pszCommName=u''

print "byref(egc):", byref(egc)
...
r = c_int( lctigaze.EgInit(byref(egc)))


print 'lctigaze.EgInit returned:', r
