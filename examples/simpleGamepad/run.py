...
class ExperimentRuntime(ioHubExperimentRuntime):
    ...
    def run(self,*args,**kwargs):
        ...
        expYamlStruct=self.getLoadedExperimentConfiguration()
        expParam=self.getSavedExperimentParameters()
        sessionParam=self.getSavedSessionParameters()
        userParam=self.getSavedUserDefinedParameters()

        print "=============================="
        print "\n Experiment YAML Struct:\n"
        import pprint
        pprint.pprint(expYamlStruct)
        print ''
        print "=============================="
        print "\n Experiment Parameters:\n"
        pprint.pprint(expParam)
        print ''
        print "=============================="
        print "\n Session Parameters:\n"
        pprint.pprint(sessionParam)
        print ''
        print "=============================="
        print "\n User Parameters:\n"
        pprint.pprint(userParam)
        print ''
        print "=============================="
        ...
        psychoWindow = visual.Window(screen_resolution, monitor="testMonitor", units=display.getDisplayCoordinateType(), fullscr=True, allowGUI=False,screen=display.getStimulusScreenIndex())
