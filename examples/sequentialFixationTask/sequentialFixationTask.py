...
class ExperimentRuntime(ioHubExperimentRuntime):
    ...
    def run(self,*args,**kwargs):
        ...
        if daq is None:
            print "DAQ Device cdid not load. "
            #return 0
...
##        conditionVariablesFile="C:\\Users\\iView X\\Desktop\\OpenPsycho2.7.3.1-32bit\\python-2.7.3\\other-packages\\ioHub\\examples\\sequentialFixationTask\\resources\\condition_files\\DEFAULT_TRIAL_DATA.xls"
        ...
        self.window = visual.Window(display.getStimulusScreenResolution(),
                                            monitor="testMonitor", 
        ...
        if tracker:
            ...
            msampleTrig=DeviceEventTrigger(tracker,EventConstants.EYE_SAMPLE,{},self.targetScreen.setDynamicStimPosition)
            bsampleTrig=DeviceEventTrigger(tracker,EventConstants.BINOC_EYE_SAMPLE,{},self.targetScreen.setDynamicStimPosition)
        ...
        dtrigger=DeviceEventTrigger(kb,EventConstants.KEYBOARD_PRESS,{'key':'SPACE'},self._spaceKeyPressedDuringTargetState)
    ...
    def runBlockSet(self, blockSet):
        ...
        for trialSet in blockSet.getNextConditionSet():
            ...
            dres=display.getStimulusScreenResolution()
            ...
            dtrigger=DeviceEventTrigger(kb,EventConstants.KEYBOARD_PRESS,{'key':'SPACE'})
            self.instructionScreen.setDeviceEventTriggers(dtrigger)
            self.instructionScreen.setText("Press 'Space' key".center(32)+"\n"+("when Ready to Start Block %d"%(blockSet.getCurrentConditionSetIteration())).center(32))
            ...
            if daq:
                #print "Enabling DAQ recording..."
                daq.enableEventReporting(True)
