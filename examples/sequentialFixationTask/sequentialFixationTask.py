...
sequentialFixationTask
++++++++++++++++++++++

Overview:
---------

The main purpose for the sequentialFixationTask is to implement a simple 
prototype experiment paradigm for collecting fixation data from multiple 
eye tracking devices, looking at fixation accuracy and precision, 
among other things.

To Run:
-------

1. Ensure you have followed the ioHub installation 
   instructions at http://www.github.com/isolver/iohub/wiki
...
from ioHub.experiment import (ioHubExperimentRuntime, psychopyVisual, 
                              DeviceEventTrigger, ClearScreen, 
                              InstructionScreen, FileDialog)
                             
from  experimentResources import (TargetScreen, ExperimentVariableProvider, 
                                  getAutoGeneratedTargetPositions)
...
#        conditionVariablesFile="C:\\Users\\iView X\\Desktop\\OpenPsycho2.7.3.1-32bit\\python-2.7.3\\other-packages\\ioHub\\examples\\sequentialFixationTask\\resources\\condition_files\\DEFAULT_TRIAL_DATA.xls"
        ...
        #
        #display.setStimulusScreenIndex(not display.getStimulusScreenIndex())
        ...
        self.window = psychopyVisual.Window(display.getStimulusScreenResolution(),
                                            monitor="testMonitor", 
        ...
        dtrigger=DeviceEventTrigger(kb,EventConstants.KEYBOARD_PRESS_EVENT,{'key':'Space'},self._spaceKeyPressedDuringTargetState)             
    ...
    def runBlockSet(self, blockSet):
        ...
        for trialSet in blockSet.getNextConditionSet():
            ...
            TARGET_POSITIONS=getAutoGeneratedTargetPositions(dres[0],dres[1],self.HORZ_SCALING,self.VERT_SCALING,self.HORZ_POS_COUNT,self.VERT_POS_COUNT)
    ...
    def _spaceKeyPressedDuringTargetState(self,flipTime, stateDuration, event):
        if self._TRIAL_STATE:
            ...
            if trial[column_name]<=-100: # no RT has been registered yet
                trial[column_name]=event['hub_time']-flipTime
        return False
