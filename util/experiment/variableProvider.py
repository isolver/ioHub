            ...
            if rtype==1:
                ...
                if (rvalue[0] in ('[','(')) and (rvalue[-1] in (']',')')) and (rvalue.count(',') in (2,3)):
                    try:
                        ...
                        ioHub.print2err("*** ERROR HANDLING COLOR COLUMN: ",cname,". Setting to 64 char string.")
                ...
                ioHub.print2err("*** ERROR HANDLING COLUMN: ",cname," bad type: ",rtype,". Setting to 8 bit unsigned int")
