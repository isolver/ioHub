...
from psychopy import  core as psychopyCore, visual as psychopyVisual, gui as psychopyGui
...
a command prompt at the ioHub/examples/simple folder and type:
    ...
    def _initalizeConfiguration(self):
        ...
        sysInfoFile=open(os.path.join(self.paths.SYS_INFO._path,'systemInfo.txt'),'w')
        from ioHub.util.systemInfo import printSystemInfo
        printSystemInfo(sysInfoFile)
        sysInfoFile.close()

        ioHubInfo= self.configuration.get('ioHub',None)
    ...
    def _displayExperimentSettingsDialog(self):
        ...
        """
        experimentDlg=psychopyGui.DlgFromDict(self.experimentConfig, 'Experiment Launcher', self._experimentConfigKeys, self._experimentConfigKeys, {})
        if experimentDlg.OK:
            return False
        return True
    ...
    def _displayExperimentSessionSettingsDialog(self):
        ...
        sessionDlg=psychopyGui.DlgFromDict(allSessionDialogVariables, 'Experiment Session Settings', [], sessionVariableOrder)
